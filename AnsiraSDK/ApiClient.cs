...
{
  /// <summary>
  /// API Client for Ansira CRM / SSO API
  ...
  public class ApiClient
  {
    ...
    /// <summary>
    /// Sign-out a User from the Ansira SSO
    /// </summary>
    ...
    /// <summary>
    /// Get the Purina dry food brands supported by the API
    /// </summary>
    /// <param name="petTypeId">Integer ID of PetType</param>
    ...
    /// <summary>
    /// Get the Purina wet food brands supported by the API
    /// </summary>
    /// <param name="petTypeId">Integer ID of PetType</param>
    /// <returns>IList of partial Ansira.Objects.Brand objects or null if none</returns>
    /// <exception cref="System.ArgumentNullException">Thrown when Pet Type ID is null</exception>
